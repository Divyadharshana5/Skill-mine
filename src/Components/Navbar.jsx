...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-center sticky top-0 z-100 bg-[#fff] shadow-md w-full">
      ...
      <div
        className={`fixed inset-0 backdrop-blur-sm top-0 left-0 h-[100vh] w-full bg-[#00000001b] opacity-50 p-5 z-40 transition-opacity duration-400 ${
          ...
          <nav className="relative h-full mt-10 flex flex-col gap-1 text-white">
            <form action="submit" className="flex w-full relative">
              <input
                ...
                placeholder="Search Courses..."
              />
              <button className="absolute right-0 text-[1em] bg-purple-500 px-5 h-full transition-ease-in-out duration-0.3s cursor-pointer">
                <RiSearch2Line color="#7d0ed2" size={22} />
              </button>
            </form>
          </nav>
